...
import { COMPANY_ACCOUNT_ITEM_REVISION_KONTRAGENT_CREATE_PRICE_ACTION_TYPE as ACTION_TYPE } from './company-account-item-revision-kontragent-create-price.constant';

export const initialState = {
  request: initRequestState(),
};

export function companyAccountItemRevisionKontragentCreatePriceReducer(
  state = initialState,
  action,
) {
  switch (action.type) {
