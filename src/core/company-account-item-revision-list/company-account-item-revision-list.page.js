...
import { CompanyAccountItemSelfRevisionCreateInfo } from './frame/company-account-item-self-revision-create-info.component';
  ...
  return (
    <NavigationComponent>
      <Grid spacing={6} container>
        ...
        <Grid item>
          <CompanyAccountItemSelfRevisionCreateInfo />
        </Grid>
        <Grid item>
