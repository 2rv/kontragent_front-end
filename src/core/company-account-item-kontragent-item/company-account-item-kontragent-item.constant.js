...
import {
  ...
  COMPANY_ACCOUNT_ITEM_KONTRAGENT_ITEM_REVIEW_LIST_ROUTE_PATH_DYNAMIC,
} from '../company-account-item-kontragent-item-review-list/company-account-item-kontragent-item-review-list.constant';
...
export const COMPANY_ACCOUNT_ITEM_KONTRAGENT_ITEM_NAVIGATION = [
  ...
  },
  {
    ...
    path: () => {
      return COMPANY_ACCOUNT_ITEM_KONTRAGENT_ITEM_REVIEW_LIST_ROUTE_PATH_DYNAMIC(
        {
          companyId: getQuery('companyId'),
          kontragentId: getQuery('kontragentId'),
        },
    ...
    pathname: COMPANY_ACCOUNT_ITEM_KONTRAGENT_ITEM_REVIEW_LIST_ROUTE_PATH,
  },
];
