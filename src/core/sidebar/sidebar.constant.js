export const NAVMENU_ITEMS = [
  ...
  {
    tid: 'Контрагент арбитражные дела',
  ...
  {
    tid: 'Страница с новостью',
    pathname: '/news-id',
    path: '/news-id',
  },
  {
    tid: 'Страница моих рефералов',
    pathname: '/referral',
    path: '/referral',
  },
  {
