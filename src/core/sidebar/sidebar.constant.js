...
export const NAVMENU_ITEMS = [
  ...
  {
    tid: 'SIDEBAR.NAV_MENU.ITEMS.REGISTRATION',
    pathname: '/signup',
    path: '/signup',
  },
  {
    tid: 'SIDEBAR.NAV_MENU.ITEMS.COMPANY_REGISTRATION',
    pathname: '/auth/account-info',
    path: '/auth/account-info',
  },
  {
    tid: 'SIDEBAR.NAV_MENU.ITEMS.VERIFICATION_STATUS',
  ...
  {
    tid: 'SIDEBAR.NAV_MENU.ITEMS.MY_LEGAL_ENTITES',
    pathname: '/my-legal-entities',
    path: '/my-legal-entities',
  },
  {
    tid: 'SIDEBAR.NAV_MENU.ITEMS.BOOKS',
  ...
  {
    tid: 'SIDEBAR.NAV_MENU.ITEMS.MY_VERIFICATIONS',
    pathname: '/my-verifications',
    path: '/my-verifications',
  },
  {
    tid: 'SIDEBAR.NAV_MENU.ITEMS.MY_INQUIRIES_TO_LAWYERS',
