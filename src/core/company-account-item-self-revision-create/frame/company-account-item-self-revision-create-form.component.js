...
import { COMPANY_ACCOUNT_ITEM_SELF_REVISION_CREATE_DATA_NAME } from '../../company-account-item-self-revision-create';

import { FileUploadFieldContainer } from '../../../lib/common/file-upload-field/file-upload-field.container.js';
import { text } from '../../../lib/common/text';

import { companyAccountItemSelfRevisionCreateChangeYearPeriod } from '../company-account-item-self-revision-create.action';

export const CompanyAccountItemSelfRevisionCreateFormComponent = (props) => {
  const {
    handleChange,
    handleBlur,
    handleSubmit,
        ...
        >
          <Grid xs={12} item>
            <TextFieldElement
              ...
              name={COMPANY_ACCOUNT_ITEM_SELF_REVISION_CREATE_DATA_NAME.TITLE}
              onChange={handleChange}
              storeOnChange={companyAccountItemRevisionCreateChangeYearPeriod}
              onBlur={handleBlur}
              value={
                values[
                  COMPANY_ACCOUNT_ITEM_SELF_REVISION_CREATE_DATA_NAME.TITLE
                ]
              }
              error={isFieldError(
                COMPANY_ACCOUNT_ITEM_SELF_REVISION_CREATE_DATA_NAME.TITLE,
