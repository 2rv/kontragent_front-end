...
import { ENTITY_ARBITRATION_CASES_STORE_NAME } from './arbitration-cases.constant';
import { ArbitrationCasesComponent } from './arbitration-cases.component';

export function ArbitrationCasesContainer() {
  const dispatch = useDispatch();
  const { state, pageLoading } = useSelector((state) => ({
    state: state[ENTITY_ARBITRATION_CASES_STORE_NAME],
...
export const arbitrationCasesListData = [
  {
    ...
    messages: '25',
    status: {
      title: 'ENTITY.ARBITRATION_CASES.TYPE.KONTRAGENT',
      id: 0,
    },
    info: {
      title: 'ENTITY.ARBITRATION_CASES.STATUS.RESOLVED',
      id: 0,
    },
  },
  {
    ...
    messages: '5',
    status: {
      title: 'ENTITY.ARBITRATION_CASES.TYPE.COMPLAINT',
      id: 1,
    },
    info: {
      title: 'ENTITY.ARBITRATION_CASES.STATUS.UNDER_CONSIDERATION',
      id: 1,
    },
  },
  {
    ...
    messages: '0',
    status: {
      title: 'ENTITY.ARBITRATION_CASES.TYPE.SUSPICION',
      id: 2,
    },
    info: {
      title: 'ENTITY.ARBITRATION_CASES.STATUS.REJECTED',
      id: 2,
    },
  },
  {
