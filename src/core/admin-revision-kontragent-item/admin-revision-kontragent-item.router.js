...
import { ADMIN_REVISION_KONTRAGENT_ITEM_ROUTE_PATH } from './admin-revision-kontragent-item.constant';

export function AdminRevisionKontragentItemRouter(ctx) {
  ctx.store.dispatch(setActivePath(ADMIN_REVISION_KONTRAGENT_ITEM_ROUTE_PATH));
