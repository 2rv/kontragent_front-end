  ...
  return (
    <PrimaryBox>
      <Сontent>
        <Header>
          <TitleCase>
            <TitlePrimary tid="STATISTICS_CARD.REFERRAL_SYSTEM" />
          </TitleCase>
        ...
        <ContentCase>
          <Column>
            <TextCase>
              ...
              &nbsp;
              <ValuteText tid="STATISTICS_CARD.VALUTE" />
              &nbsp;
              <TinyPrimaryText tid="STATISTICS_CARD.REFERRAL_ACCRUALS" />
            </TextCase>
            <TextCase>
              <ColoredPrimaryTitle tid="15" />
              &nbsp;
              <TinyPrimaryText tid="STATISTICS_CARD.REFERRAL_OPPERATIONS" />
            </TextCase>
            <Link tid="STATISTICS_CARD.SHOW_MORE" />
          </Column>
        </ContentCase>
      </Сontent>
    </PrimaryBox>
