...
import { ADMIN_REVISION_SELF_REVIEW_SHARE_DATA_NAME as FIELD_NAME } from './admin-revision-self-review-share.constant.js';
import { Fragment, useState } from 'react';

export function AdminRevisionSelfReviewShareComponent(props) {
  const {
    isPending,
    isSuccess,
    isError,
