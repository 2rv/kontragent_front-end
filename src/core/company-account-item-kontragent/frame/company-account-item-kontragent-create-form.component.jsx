        ...
        >
          <Grid item xs={12} lg={6}>
            <TextFieldElement
              ...
              name={COMPANY_ACCOUNT_ITEM_KONTRAGENT_DATA_NAME.NAME}
              onChange={handleChange}
              onBlur={handleBlur}
              value={values[COMPANY_ACCOUNT_ITEM_KONTRAGENT_DATA_NAME.NAME]}
              error={isFieldError(
          ...
          <Grid xs={12} lg={6} item>
            <TextFieldElement
              ...
              name={COMPANY_ACCOUNT_ITEM_KONTRAGENT_DATA_NAME.INN}
              onChange={handleChange}
              onBlur={handleBlur}
              value={values[COMPANY_ACCOUNT_ITEM_KONTRAGENT_DATA_NAME.INN]}
              error={isFieldError(
