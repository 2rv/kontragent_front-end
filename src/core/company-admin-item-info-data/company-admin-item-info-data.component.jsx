import { Paper, Divider, Grid, Typography, Alert, Box } from '@mui/material';
import { SkeletonListComponent } from '../../lib/common/skeleton/skeleton-list.component';

export function CompanyAdminItemInfoDataComponent(props) {
  const {
    data: {
      // req
